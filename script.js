...
const featureData = {
  ...
  printing: {
    ...
    text: "مخرجات طباعة واضحة حسب نوع العملية بدل شكل واحد لكل حاجة",
    image: "assets/pc/sales.png",
    visual: "print",
    points: ["فاتورة A4 منظمة", "طباعة حرارية سريعة", "باركود لاصق للمنتجات", "تقرير قابل للطباعة"],
    prints: ["A4", "طباعة حرارية", "باركود لاصق", "تقرير A4"]
  },
  inventory: {
    kicker: "المخزون",
    title: "مخزون واضح",
  ...
  sales: {
    kicker: "الفواتير",
    title: "فواتير البيع",
    text: "قائمة فواتير منظمة مع إجراءات الطباعة والواتساب والمعاينة",
    image: "assets/pc/sales.png",
    points: ["بحث في الفواتير", "عرض وطباعة وحذف حسب الصلاحية", "واتساب مباشر", "تجهيز مناسب للمراجعة"],
    prints: ["فاتورة A4", "إيصال كاشير", "واتساب عميل"]
  },
  updates: {
    kicker: "التطوير",
